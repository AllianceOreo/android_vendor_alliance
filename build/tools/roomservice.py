...
DEBUG = False
default_manifest = ".repo/manifests/alliance_default.xml"
custom_local_manifest = ".repo/local_manifests/alliance_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "alliance.dependencies"
org_manifest = "AllianceOreo"  # leave empty if org is provided in manifest
org_display = "AllianceOreo"  # needed for displaying
